...
exports.getOrdersForExpert = void 0;
...
async function getOrdersForExpert(req, res) {
    const user = req.user;
    const orders = await Order_model_1.Order.findBy({ expert: { id: user.id } });
...
exports.getOrdersForExpert = getOrdersForExpert;
