...
let ExpertStrategy = class ExpertStrategy extends (0, passport_1.PassportStrategy)(passport_jwt_1.Strategy, 'expert') {
    constructor() {
        super({
    ...
    async validate(jwt_payload) {
        ...
        if (!user || user.profile !== roles_1.ROLES.Expert) {
            return null;
        }
        return user;
    }
};
ExpertStrategy = __decorate([
    (0, common_1.Injectable)(),
    __metadata("design:paramtypes", [])
], ExpertStrategy);
exports.ExpertStrategy = ExpertStrategy;
//# sourceMappingURL=expert.strategy.js.map